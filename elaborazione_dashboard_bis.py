...
def find_file(keyword):
    """Trova il file che contiene la keyword nel nome."""
...
def build_comunali(df):
    ...
    for _, r in df.iterrows():
        ...
        cand = str(
            r.get("candidato_riferimento", "N/D")
        ).strip()
...
app.layout = dbc.Container([
    ...
    dbc.Tabs(
        ...
        children=[
            ...
            # =================================================
            dbc.Tab(
                label="🗳️ Ultima Tornata",
                tab_id="tab-snapshot",
                children=[

                    html.P(
                        "Risultati ultima elezione disponibile.",
    ...
    html.P(
        "Dati elaborati automaticamente - uso non ufficiale",
