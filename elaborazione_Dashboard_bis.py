...
BASE_DIR = cartella_corrente = os.path.dirname(os.path.abspath(__file__))
BASE_DIR = os.path.join(cartella_corrente, "XLMS")
...
# =========================================================
# TREND (UNICA MODIFICA = FIX RANGE GRAFICI DOPO)
# =========================================================
...
server = app.server  # Fondamentale per il deploy online!
...
# =========================================================
# FIX SOLO TREND: RANGE DINAMICO (MODIFICA UNICA)
# =========================================================
